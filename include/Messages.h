...
#define WM_AGENT_SESSIONS_UPDATED (WM_USER + 208)
#define WM_CLAUDE_HOOK_EVENT (WM_USER + 209)
#define WM_CLAUDE_PHASE_UPDATED (WM_USER + 210)
#define WM_CLAUDE_INSTALL_STATUS (WM_USER + 211)
